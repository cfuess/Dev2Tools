        ...
        loadChart: function (employer) {
            ...
            function drawChart() {
                ...
                employer.LiabilityPeriods.forEach((element, index, array) => {
                    ...
                    periods.push(['Active', color + tooltip, startDate1.toDate(), startDate2.toDate()]);
                    
                    barColors.push(color);
                    console.log(periods)
                });
                    dataTable2.addRows(periods);
                ...
                employer.WagePeriods.forEach((element, index, array) => {
                    ...
                    wages.push(['Wages', color , startDate1.toDate(), startDate2.toDate()]);
                    // console.log(row + ",")
                    barColors.push(color);

//                     var rcolor = '#'+'0123456789abcdef'.split('').map(function(v,i,a){
//   return i>5 ? null : a[Math.floor(Math.random()*16)] }).join('');

// console.log(rcolor);
// barColors.push(rcolor)
                });
                    dataTable2.addRows(wages);

// barColors.push('#2bff00');
// barColors.push('#2bff00');

// barColors.push('#0800ff');
// barColors.push('#0800ff');

// barColors.push('#ff00dd');
// barColors.push('#ff00dd');

barColors.push('#d1cc2c');
barColors.push('#d1cc2c');
...
debugger;
                ...
                var rows = [];
                // dataTable2.addRows([
                //     ['President', '1-George Washington-1', new Date(2008, 3, 30), new Date(2009, 2, 4)],
                //     ['President', '2-John Adams-2', new Date(2009, 2, 4), new Date(2010, 2, 4)],
                //     ['President', '3-Thomas Jefferson-3', new Date(2011, 2, 4), new Date(2012, 2, 4)]
                // ])
                //     //rows.push(['Active', tooltip, startDate1.format('MM/DD/YYYY'), startDate2.format('MM/DD/YYYY')]);

                //     rows.push([ "Wages", "4-Q4 2012 $33,402.10-4", new Date('2012-10-01T07:00:00.000Z'), new Date('2012-12-31T08:00:00.000Z')]);
                //     rows.push([ "Wages", "5-No Payroll - Q3 2017 $0.00-4", moment('2012-10-01T07:00:00.000Z').toDate(), moment('2012-12-31T08:00:00.000Z').toDate()]);
                //     rows.push([ "Wages", "6-12/15/17 - 3/16/18-6", moment('Fri Dec 15 2017 00:00:00 GMT-0800 (Pacific Standard Time)').toDate(), moment('Fri Mar 16 2018 15:58:41 GMT-0700 (Pacific Daylight Time)').toDate()]);
                //     rows.push([ "Wages", "7-No Payroll - Q3 2017 $0.00-7", moment('2018-10-01T07:00:00.000Z').toDate(), moment('2018-12-31T08:00:00.000Z').toDate()]);
                //     rows.push([ "Wages", "8-12/15/17 - 3/16/18-8", moment('Fri Dec 15 2018 00:00:00 GMT-0800 (Pacific Standard Time)').toDate(), moment('Fri Mar 16 2019 15:58:41 GMT-0700 (Pacific Daylight Time)').toDate()]);
                    
                    // dataTable2.addRows(rows);
